...
echo "🔄 Fixing subjects according to flowchart (safe method)...\n\n";

// Delete related data first
echo "🗑️ Deleting related data...\n";
DB::table('program_studi_subjects')->delete();
echo "✅ Deleted program_studi_subjects\n";

DB::table('student_choices')->delete();
echo "✅ Deleted student_choices\n";

// Delete existing subjects
DB::table('subjects')->delete();
echo "✅ Deleted existing subjects\n";
