...
# Copy debug script
scp test_vps_major_recommendations_debug.php $VPS_USER@$VPS_IP:$PROJECT_PATH/
...
ssh $VPS_USER@$VPS_IP "cd $PROJECT_PATH && bash -c '
    echo \"🧪 Testing MajorRecommendations data structure...\"
...
echo "🌐 Check your VPS URL to see if the data is now showing without filter errors!"
