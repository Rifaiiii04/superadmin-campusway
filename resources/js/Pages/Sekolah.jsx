    ...
    return (
        <div className="p-6">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600">Kelola data sekolah yang terdaftar dalam sistem</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <p className="text-sm font-medium text-gray-600">Sekolah Nonaktif</p>
                            <p className="text-2xl font-bold text-gray-900">0</p>
                        </div>
                    </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow">
                <div className="px-6 py-4 border-b border-gray-200">
                    <h3 className="text-lg font-medium text-gray-900">Daftar Sekolah</h3>
                </div>
                <div className="p-6">
                    <div className="text-center py-12">
                        <BuildingOfficeIcon className="h-12 w-12 text-gray-400 mx-auto mb-4" />
                        <h3 className="text-lg font-medium text-gray-900 mb-2">Belum ada data sekolah</h3>
                        <p className="text-gray-500">Mulai dengan menambahkan sekolah pertama Anda</p>
                    </div>
                </div>
            </div>
        </div>
