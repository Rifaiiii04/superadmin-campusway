...
class SimpleFinalSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        // Insert Major Recommendations dengan data JSON yang lebih pendek
        $majorRecommendations = [
            [
                'major_name' => 'Kedokteran',
                'category' => 'Saintek',
                'required_subjects' => json_encode(['Biologi', 'Kimia']),
                'preferred_subjects' => json_encode(['Matematika']),
                'career_prospects' => 'Dokter',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'preferred_subjects' => json_encode(['Kimia']),
                'career_prospects' => 'Insinyur',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
            [
                ...
                'preferred_subjects' => json_encode(['Bahasa Inggris']),
                'career_prospects' => 'Ekonom',
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ],
