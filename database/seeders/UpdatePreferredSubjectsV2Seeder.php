...
class UpdatePreferredSubjectsV2Seeder extends Seeder
{
    /**
    ...
    {
        $this->command->info('=== UPDATING PREFERRED SUBJECTS V2 - 2 MATA PELAJARAN WAJIB ===');

        // Data mata pelajaran pilihan revisi - WAJIB 2 mata pelajaran
        $preferredSubjectsData = [
            ...
            'Informatika Medis atau Informatika Kesehatan' => ['Biologi', 'Matematika'],
        ...
        $this->command->info("\n=== PREFERRED SUBJECTS V2 UPDATE COMPLETED ===");
