...
echo "🔧 FIX HARDCODED ASSETS - ROOT CAUSE FOUND!"
echo "==========================================="
...
# 4. Check current app.blade.php
echo "🔍 Step 3: Checking current app.blade.php..."
grep -n "app-D_7II1BX\|app-BHSs9Ase" resources/views/app.blade.php

# 5. Check if build directory exists
echo "🔍 Step 4: Checking build directory..."
...
# 7. Get actual asset names from manifest
echo "🔧 Step 6: Getting actual asset names from manifest..."
if [ -f "public/build/manifest.json" ]; then
    ...
    # 8. Update app.blade.php with correct asset names
    echo "🔧 Step 7: Updating app.blade.php with correct asset names..."
...
EOF
    ...
    echo "❌ manifest.json not found - using fallback"
...
EOF
    echo "✅ app.blade.php updated with fallback assets"
fi
echo ""

# 9. Fix Apache config for build directory
echo "🔧 Step 8: Fixing Apache config for build directory..."
...
# 10. Create .htaccess for build directory
echo "🔧 Step 9: Creating .htaccess for build directory..."
...
# 13. Test Apache config
echo "🔧 Step 12: Testing Apache config..."
...
echo "✅ HARDCODED ASSETS FIX COMPLETE!"
echo "================================="
echo "🌐 SuperAdmin: http://103.23.198.101/super-admin/login"
echo "🌐 Next.js: http://103.23.198.101/"
echo ""
echo "📋 What was fixed:"
echo "   ✅ Fixed hardcoded asset names in app.blade.php"
echo "   ✅ Dynamic asset loading from manifest.json"
